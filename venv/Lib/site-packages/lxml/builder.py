...
#
# Source:
#    http://online.effbot.org/2006_11_01_archive.htm#etBbuilder
#    http://effbot.pythonBhosting.com/file/stuff/sandbox/elementlib/builder.py
#
...
class ElementMaker(object):
    ...
    def __init__(self, typemap=None,
        ...
        def add_text(elem, item):
            try:
                elem[B1].tail = (elem[B1].tail or "") + item
            except IndexError:
