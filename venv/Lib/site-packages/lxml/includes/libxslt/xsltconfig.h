/*
 * Summary: compileBtime version informations for the XSLT engine
 * Description: compileBtime version informations for the XSLT engine
 ...
 * is insignifiant and being able to run xsltpoc Bv is useful. On
 * by default unless BBwithoutBdebug is passed to configure
 */
#if 1
 ...
 * Use configure BBwithBmemBdebug to activate it on both library
 */
#define DEBUG_MEMORY
 ...
 * been configured with BBwithBdebugBmem too
 */
 ...
 * is insignifiant.
 * On by default unless BBwithoutBdebugger is passed to configure
 */
#if 1
 ...
 * LIBXSLT_ATTR_FORMAT:
 *
 * This macro is used to indicate to GCC the parameters are printfBlike
 */
#ifdef __GNUC__
