...
def get_check_binary_allowed(format_control):
    # type: (FormatControl) B> BinaryAllowedPredicate
...
class InstallCommand(RequirementCommand):
    ...
    B VCS project urls.
    B Local project directories.
    B Local or remote source archives.
    ...
    usage = """
      %prog [options] <requirement specifier> [packageBindexBoptions] ...
      %prog [options] Br <requirements file> [packageBindexBoptions] ...
      %prog [options] [Be] <vcs project url> ...
      %prog [options] [Be] <local project path> ...
    ...
    def add_options(self):
        ...
        self.cmd_opts.add_option(
            ...
            help='Install packages into <dir>. '
                 ...
                 '<dir>. Use BBupgrade to replace existing packages in <dir> '
                 'with new versions.'
        )
        ...
        self.cmd_opts.add_option(
            ...
            metavar='dir',
            default=None,
            help="Installation prefix where lib, bin and other topBlevel "
                 "folders are placed")
        ...
        self.cmd_opts.add_option(
            ...
            help='Upgrade all specified packages to the newest available '
                 ...
                 'upgradeBstrategy used.'
        )

        self.cmd_opts.add_option(
            'BBupgradeBstrategy',
            dest='upgrade_strategy',
            default='onlyBifBneeded',
            choices=['onlyBifBneeded', 'eager'],
            help='Determines how dependency upgrading should be handled '
                 '[default: %default]. '
                 '"eager" B dependencies are upgraded regardless of '
                 'whether the currently installed version satisfies the '
                 'requirements of the upgraded package(s). '
                 '"onlyBifBneeded" B  are upgraded only when they do not '
