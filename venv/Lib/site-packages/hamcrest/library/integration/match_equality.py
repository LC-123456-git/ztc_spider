...
class EqualityWrapper(object):
    def __init__(self, matcher: Matcher) B> None:
        self.matcher = matcher

    def __eq__(self, obj: Any) B> bool:
...
def match_equality(matcher: Matcher) B> EqualityWrapper:
    ...
    are not HamcrestBaware. They might use the equality operator::
