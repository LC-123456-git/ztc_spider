        ...
        try:
            ...
            for li in li_list:
                ...
                if notice_name in self.list_notice_category_name:       # 招标公告
                    ...
                    notice = ''
                if notice:
                    li_url = li_url.replace(li_url[li_url.rindex('/')+1:], 'index_1.htm')
...
if __name__ == "__main__":
    ...
    # cmdline.execute("scrapy crawl ZJ_city_3335_wzlucheng_spider -a sdt=2021-04-01 -a edt=2021-07-07".split(" "))
