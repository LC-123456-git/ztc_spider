...
class MySpider(CrawlSpider):
    ...
    # 招标公告
    list_notice_category_num = ["招标公告", "采购公告", "交易公告", "通知公告"]
    # 资格预审结果公告
    list_qualification_advance_notice = ["资审结果公示"]
    # 招标变更
    list_alteration_category_num = ["更正公告", "变更公告"]
    # 招标异常
    list_zb_abnormal = ["流标公示", "废标公告", "异常公告"]
    # 中标公告
    list_win_notice_category_num = ["中标（成交）公告", "交易结果公示", "中标公示"]
    # 其他公告
    ...
    def parse_data_urls(self, response):
        try:
            ...
            for urls in records:
                ...
                # 中标公告
                elif category_num in self.list_win_notice_category_num or re.search("中标结果", title_name):
                    cb_kwargs = {"name": const.TYPE_WIN_NOTICE}
                # 未知公告
                else:
                    cb_kwargs = {"name": const.TYPE_UNKNOWN_NOTICE}
...
if __name__ == "__main__":
    ...
    # cmdline.execute("scrapy crawl province_41_guizhou_spider -a sdt=2021-03-01 -a edt=2021-03-01".split(" "))
