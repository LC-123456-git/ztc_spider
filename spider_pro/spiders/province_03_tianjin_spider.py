...
if __name__ == "__main__":
    ...
    cmdline.execute("scrapy crawl province_03_tianjin_spider -a sdt=2021-06-10 -a edt=2021-06-11".split(" "))
    # cmdline.execute("scrapy crawl province_03_tianjin_spider".split(" "))