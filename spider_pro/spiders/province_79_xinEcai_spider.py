            ...
            if self.enable_incr:
                ...
                if response.xpath('//ul[@class="bidding-list"]/li/a/@href'):
                    ...
                    for li in range(len(data_li_list)):
                        ...
                        yield scrapy.FormRequest(url=response.url, formdata=_data_dict, callback=self.parse_data_info,
...
if __name__ == "__main__":
    ...
    # cmdline.execute("scrapy crawl province_79_xinEcai_spider -a sdt=2021-04-01 -a edt=2021-06-07".split(" "))
