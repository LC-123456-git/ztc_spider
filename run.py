...
if __name__ == '__main__':
    ...
    # cmdline.execute("scrapy crawl province_77_zhaobide_spider -a sdt=2021-01-01 -a edt=2021-06-15".split(" "))
    # cmdline.execute("scrapy crawl province_53_bilian_spider -a sdt=2020-01-01 -a edt=2021-06-10".split(" "))
    # cmdline.execute("scrapy crawl province_14_zhejiang_spider -a sdt=2020-06-01 -a edt=2021-06-11".split(" "))
    # cmdline.execute("scrapy crawl province_57_jingcaizongheng_spider -a sdt=2020-01-01 -a edt=2021-06-11".split(" "))
